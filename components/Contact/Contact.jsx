        ...
        <div className="bg-white pb-32">
          <div className="container mx-auto bg-white pt-10 rounded px-4">
            ...
            <div className="flex flex-col lg:flex-row">
              <div className="lg:w-2/3 sm:w-full order-2 lg:order-1">
                <div className="mx-auto pt-4">
                  <div className="container mx-auto">
                    <div className="flex flex-col lg:flex-row w-full">
                      <div className="xl:w-1/2 lg:w-1/2 flex flex-col mb-6 mx-6 order-2 lg:order-1">
                        <label
                          htmlFor="fullname"
                    ...
                    <div className="flex flex-row-reverse mx-6 items-center">
                      ...
                      {/* <ul className="flex gap-6 justify-center me-4">
                        <li>
                          <a
                            href="/"
                            rel="noreferrer"
